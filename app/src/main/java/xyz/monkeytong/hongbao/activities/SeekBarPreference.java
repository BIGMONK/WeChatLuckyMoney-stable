...
public class SeekBarPreference extends DialogPreference {
    ...
    private void setHintText(int delay) {
        if (delay == 0) {
            ...
            this.textView.setText("延迟"+(delay*100)+ "毫秒左右"+ getContext().getString(R.string.delay_then) + hintText);

        }else {
            this.textView.setText(getContext().getString(R.string.delay_delay) + (delay/10f) + getContext().getString(R.string.delay_sec)+"左右" + getContext().getString(R.string.delay_then) + hintText);
